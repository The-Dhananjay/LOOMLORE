...
export const metadata = { title: 'Luxury Heirlooms — Loomlore' };

export default function LuxuryPage() {
  const states = [...STATES].sort((a, b) => b.priceINR - a.priceINR).slice(0, 8);

  return (
    <div className="mx-auto w-full max-w-7xl px-6 py-32 bg-[#faeee7] text-[#33272a] font-sans">
      <header className="max-w-3xl">
        <p className="label-eyebrow text-xs">Royal Reserve Collection</p>
        <h1 className="display-h mt-3 text-5xl text-[#33272a] sm:text-6xl">Luxury Heirlooms.</h1>
        <p className="mt-4 text-base leading-relaxed text-[#594a4e]">
          The finest silk sarees, hand-zardozi sherwanis, and 1,000-stitch Sozni pashminas across India.
        </p>
      </header>
