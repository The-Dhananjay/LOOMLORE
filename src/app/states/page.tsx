...
export const metadata = { title: '28 States & UTs Heritage — Loomlore' };

export default function StatesIndexPage() {
  return (
    <div className="mx-auto w-full max-w-7xl px-6 py-32 bg-[#faeee7] text-[#33272a] font-sans">
      <header className="max-w-3xl">
        <p className="label-eyebrow text-xs">The Craft Subcontinent</p>
        <h1 className="display-h mt-3 text-5xl text-[#33272a] sm:text-6xl">All Twenty-Eight States.</h1>
        <p className="mt-4 text-base leading-relaxed text-[#594a4e]">
          Discover authentic handwoven traditional garments for Women and Men across all 28 states of India. Select a state to explore its heritage weaver cooperatives.
        </p>
      </header>
        ...
        {STATES.map((s) => (
          ...
          >
            <div>
              ...
              <p className="mt-1 text-xs text-[#594a4e]/70">{s.fabric} · {s.embroidery}</p>

              {/* Women & Men Garment Badges */}
